...
class TasksService:
    ...
    def create_task(
        ...
        *,
        ...
        kind_configs = [h5p is not None, visual is not None, scratch is not None, calliope is not None, filius is not None]
    ...
    def update_task(
        ...
        *,
        ...
        kind_updates = [h5p is not _UNSET, visual is not _UNSET, scratch is not _UNSET, calliope is not _UNSET, filius is not _UNSET]
