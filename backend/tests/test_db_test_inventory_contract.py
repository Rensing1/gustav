...
def test_teaching_course_api_db_integration_files_are_marked_as_db_write() -> None:
    from backend.tools import db_test_inventory
    ...
    for path in (
        "backend/tests/test_teaching_course_existence_helpers_optional.py",
        "backend/tests/test_teaching_courses_api.py",
        "backend/tests/test_teaching_courses_update_delete_api.py",
        "backend/tests/test_teaching_courses_update_semantics.py",
    ):
        assert records[path].marker_status == "marked-db"
        assert "db_write" in records[path].markers


def test_teaching_materials_and_members_api_db_integration_files_are_marked_as_db_write() -> None:
    from backend.tools import db_test_inventory
    ...
    for path in (
        "backend/tests/test_teaching_materials_files_api.py",
        "backend/tests/test_teaching_materials_markdown_api.py",
        "backend/tests/test_teaching_members_api_default_limit.py",
        "backend/tests/test_teaching_members_semantics.py",
    ):
        assert records[path].marker_status == "marked-db"
        assert "db_write" in records[path].markers


def test_teaching_modular_api_db_integration_files_are_marked_as_db_write() -> None:
    from backend.tools import db_test_inventory
    ...
    for path in (
        ...
        "backend/tests/test_teaching_module_section_releases_api.py",
        "backend/tests/test_teaching_module_sections_list_api.py",
        "backend/tests/test_teaching_module_sections_releases_headers.py",
    ):
        assert records[path].marker_status == "marked-db"
        assert "db_write" in records[path].markers
