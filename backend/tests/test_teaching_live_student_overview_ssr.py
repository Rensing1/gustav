...
@pytest.mark.anyio
async def test_student_live_overview_page_is_retired_for_teachers(monkeypatch: pytest.MonkeyPatch) -> None:
    store = install_session_store(monkeypatch, main)
    owner = store.create(sub="teacher-student-live-retired", name="Owner", roles=["teacher"])
