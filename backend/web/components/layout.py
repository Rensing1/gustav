...
<body>
    ...
    <link rel="stylesheet" href="/static/css/student_modular_unit.css?v=1">
    <link rel="stylesheet" href="/static/css/teaching_modular_unit_editor.css?v=3">
    ...
    <SCRIPT src="/static/js/teaching_modular_unit_editor.js?v=4" defer></SCRIPT>
