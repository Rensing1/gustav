...
- fix(db/sections): Retry path now fetches the inserted row after 23505; concurrency test enforces contiguous positions without relying on sorting artefacts.
