...
- Echte DB/RLS-Kandidaten ohne `db_read`/`db_write`: 47
- Echte DB/RLS-Kandidaten mit `db_read`/`db_write`: 41
...
| backend/tests/test_db_session_store.py | real-db | - | missing-db-marker | env:SESSION_TEST_DSN | Review for db_read/db_write before marker hardening |
