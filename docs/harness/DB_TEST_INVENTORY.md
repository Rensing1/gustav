...
| backend/tests/migration/test_course_archive_lifecycle_migration.py | migration-static | - | no-db-marker-needed | migration, rls | Keep static migration contract unless it opens a DB connection |
| backend/tests/migration/test_course_deletion_worker_boundary.py | real-db | db_write | marked-db | env:DATABASE_URL, migration, psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
| backend/tests/migration/test_course_invitations_migration.py | migration-static | - | no-db-marker-needed | migration | Keep static migration contract unless it opens a DB connection |
...
| backend/tests/migration/test_dialog_tasks_schema.py | real-db | db_read | marked-db | env:DATABASE_URL, migration, psycopg-connect, psycopg-import, psycopg-required, requires-db, rls | Keep marker and isolation visible |
...
| backend/tests/migration/test_practice_completion_migration_contract.py | migration-static | - | no-db-marker-needed | migration | Keep static migration contract unless it opens a DB connection |
| backend/tests/migration/test_practice_h5p_parallel_roundtrip.py | real-db | db_write | marked-db | env:DATABASE_URL, migration, psycopg-connect, psycopg-import, psycopg-required, requires-db | Keep marker and isolation visible |
| backend/tests/migration/test_practice_native_attempt_roundtrip.py | real-db | db_write | marked-db | env:DATABASE_URL, migration, psycopg-connect, psycopg-import, psycopg-required, requires-db | Keep marker and isolation visible |
| backend/tests/migration/test_practice_session_roundtrip.py | real-db | db_write | marked-db | env:DATABASE_URL, migration, psycopg-connect, psycopg-import, psycopg-required, requires-db | Keep marker and isolation visible |
| backend/tests/migration/test_practice_session_summary_migration_contract.py | migration-static | - | no-db-marker-needed | migration | Keep static migration contract unless it opens a DB connection |
| backend/tests/migration/test_practice_sessions_migration_contract.py | migration-static | - | no-db-marker-needed | migration, rls | Keep static migration contract unless it opens a DB connection |
...
| backend/tests/test_concern_box_views_api.py | real-db | db_write | marked-db | env:RLS_TEST_SERVICE_DSN, psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
| backend/tests/test_course_invitation_mail_db.py | real-db | db_write | marked-db | psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
...
| backend/tests/test_learning_graph_db.py | real-db | db_write | marked-db | env:RLS_TEST_SERVICE_DSN, psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
...
| backend/tests/test_learning_submission_preview_api.py | real-db | db_write | marked-db | env:SERVICE_ROLE_DSN, psycopg-connect, psycopg-import | Keep marker and isolation visible |
...
| backend/tests/test_profile_provider_isolation.py | real-db | db_write | marked-db | env:SESSION_TEST_DSN, psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
...
| backend/tests/test_teacher_node_editor_db.py | real-db | db_write | marked-db | env:RLS_TEST_SERVICE_DSN, psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
...
| backend/tests/test_teaching_unit_print_db.py | real-db | db_write | marked-db | env:DATABASE_URL, env:RLS_TEST_DSN, psycopg-connect, psycopg-import | Keep marker and isolation visible |
| backend/tests/test_teaching_unit_workspace_view_api.py | real-db | db_write | marked-db | env:RLS_TEST_SERVICE_DSN, psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
| backend/tests/test_teaching_units_catalog_view_api.py | real-db | db_write | marked-db | env:RLS_TEST_SERVICE_DSN, psycopg-connect, psycopg-import, requires-db | Keep marker and isolation visible |
