...
- `backend/web/routes/learning.py` ist dadurch von 2884 auf 2533 LOC gesunken. C3 ist damit begonnen, aber noch nicht abgeschlossen: Upload-Intent-Endpoint, Submission-Flächen und die Material-File-Download-Routen müssen weiter getrennt werden.
