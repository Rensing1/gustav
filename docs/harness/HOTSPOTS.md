...
- `backend/web/routes/teaching.py` ist dadurch von 6146 auf 4477 LOC gesunken. C1 ist damit deutlich vorangekommen, aber noch nicht abgeschlossen: Route-Handler, Repo-Provider, weitere Storage-Adapter-Globals und Live-/Material-/Task-Flächen müssen weiter aus dem Hotspot herausgelöst werden.
