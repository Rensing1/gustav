...
- `backend/web/routes/learning.py` ist dadurch von 2884 auf 2420 LOC gesunken. C3 ist damit fortgeschritten, aber noch nicht abgeschlossen: Upload-Intent-Endpoint und Submission-Flächen müssen weiter getrennt werden.
