...
| `h5p-service/server.mjs` | 1847 | H5P Sidecar | Auth, Forwarding, Storage, Route-Handler und Response-Helfer weiter splitten |
...
- `h5p-service/server.mjs` ist dadurch von 1942 auf 1847 LOC gesunken; weitere H5P-Splits sollen Route-Handler, Storage-Integration und Response-Helfer betreffen.
