...
| `h5p-service/server.mjs` | 1769 | H5P Sidecar | Auth, Forwarding, Storage, Route-Handler und Response-Helfer weiter splitten |
...
- `h5p-service/server.mjs` ist dadurch von 1942 auf 1769 LOC gesunken; weitere H5P-Splits sollen Route-Handler und Storage-Integration betreffen.
