...
- `backend/web/routes/learning.py` ist dadurch von 2884 auf 1942 LOC gesunken. C3 ist damit fortgeschritten, aber noch nicht abgeschlossen: Submission-Flächen und Storage-Validierungshelfer müssen weiter getrennt werden.
