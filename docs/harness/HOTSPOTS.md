...
- `backend/web/routes/learning.py` ist dadurch von 2884 auf 2690 LOC gesunken. C3 ist damit begonnen, aber noch nicht abgeschlossen: Upload-Intent, Submission- und Material-File-Flächen müssen weiter getrennt werden.
