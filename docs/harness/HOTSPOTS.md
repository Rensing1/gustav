...
- `backend/web/routes/teaching.py` ist dadurch von 6146 auf 4241 LOC gesunken. C1 ist damit deutlich vorangekommen, aber noch nicht abgeschlossen: Unit-, Section-, Material-, Task-, Course-Module- und Live-Route-Handler, Repo-Provider und weitere Storage-Adapter-Globals müssen weiter aus dem Hotspot herausgelöst werden.
