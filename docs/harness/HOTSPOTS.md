...
- `backend/web/routes/learning.py` ist dadurch von 2884 auf 2142 LOC gesunken. C3 ist damit fortgeschritten, aber noch nicht abgeschlossen: Submission-Flächen, Storage-Validierungshelfer und interne Upload-Stub-/Proxy-Routen müssen weiter getrennt werden.
