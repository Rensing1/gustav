...
| `backend_web_routes_imports` | 3 | `backend.web.routes.*`-Imports außerhalb des Web-Adapters, vor allem Tests; innerhalb des Web-Adapters ist dieser Stil nach PR 8 Zielzustand. |
