...
| --- | ---: | --- |
| `flat_routes_imports` | 286 | Flache `routes.*`-Imports, derzeit noch in Tests. Produktiver Web-Code startet package-orientiert. |
...
| `sys_path_mutations` | 49 | Verstreute `sys.path`-/`os.sys.path`-Manipulationen, vor allem in Tests. |
