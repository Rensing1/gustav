...
| --- | ---: | --- |
| `flat_routes_imports` | 335 | Flache `routes.*`-Imports, derzeit noch in Tests. Produktiver Web-Code startet package-orientiert. |
...
| `sys_path_mutations` | 61 | Verstreute `sys.path`-/`os.sys.path`-Manipulationen, vor allem in Tests. |
