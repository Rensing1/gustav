...
| --- | ---: | --- |
| `flat_routes_imports` | 336 | Flache `routes.*`-Imports, derzeit noch in Tests. Produktiver Web-Code startet package-orientiert. |
...
| `sys_path_mutations` | 79 | Verstreute `sys.path`-/`os.sys.path`-Manipulationen, vor allem in Tests. |
