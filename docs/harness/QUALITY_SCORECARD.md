...
| backend/learning/workers/process_learning_submission_jobs.py | 1267 | n/a |
| backend/teaching/repo_db.py | 1487 | +0 |
| backend/tests/test_gustav_cli.py | 1210 | +0 |
| backend/tests/test_learning_api_contract.py | 2326 | +0 |
| backend/tests/test_learning_worker_jobs.py | 2009 | +0 |
| backend/tests/test_teaching_live_detail_api.py | 1184 | +0 |
| backend/tests/test_teaching_live_unit_summary_api.py | 1219 | +0 |
...
| backend/web/routes/teaching_live.py | 1086 | n/a |
| backend/web/static/css/gustav.css | 2684 | +0 |
| frontend/src/lib/components/learning-unit/LearningTaskCard.test.ts | 1202 | +0 |
...
| frontend/src/routes/learning/courses/[courseId]/units/[unitId]/+page.svelte | 1604 | +0 |
| frontend/src/routes/teaching/units/[unitId]/+page.svelte | 1063 | +0 |
| h5p-service/server.mjs | 1320 | -74 |
