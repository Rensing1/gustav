...
| TD-004 | Backend | Globale Kopplung und Testleckagen | Route-Fassaden und veränderte Endpoint-Globals | Produktverantwortlicher | 2026-10-01 | Appbezogene Provider und grüne Isolationstests ohne Reparatur-Fixtures | offen | F1: Profil-/CLI-Routen appbezogen; Isolation und verify-feature profile-cli-token-role grün. F2: Kummerkasten appbezogen. F3: expliziter Datenzugang für die Lernenden-Kursübersicht. F4: gemeinsamer Lehrer-Home-/Katalogdienst mit explizitem Datenzugang. F5: Inhaltseditor mit eigenem Lesedienst und explizitem Datenzugang; Nachweise im Umsetzungsplan. F6b: Lehrkraft-Workspace mit explizitem Datenzugang und frameworkunabhängiger Graphaufbereitung. F6c: Schülergraph mit explizitem Datenzugang und unveränderter SQL-Freischaltung. F6d: Modulinhalte mit explizitem Datenzugang, geteilter Kurszuordnungsprüfung und gemeinsamer Materiallink-Projektion; Dateiabruf und Mitgliedschaftsentzug im Browser geprüft. F6e: Materialdatei-/Simulationsabrufe mit expliziter DB-/Storage-/Download-Verdrahtung, Nebenläufigkeit und Dateiberechtigungen geprüft. F6f: Abschnittslisten mit explizitem Datenzugang; Materiallisten ohne globale Fassade, DB-Parität und Nebenläufigkeit geprüft. F6g: H5P-Zugriffsprüfung mit explizitem Datenzugang; globale Repository-Reparatur registrierter Learning-Endpunkte entfernt, verbleibende Helfer-Aliase abgesichert. F6h: Alle 43 in F6g aufgedeckten Teaching-DB-Adapter-Skips reproduziert und mit aktueller Testvorprüfung reaktiviert; beide gezielten Testreihenfolgen ohne Skips. DB-Inventar erhält alle bisherigen Verbraucher. Gesamtnachweis im Umsetzungsplan. F6i: Upload-Proxy mit explizitem Netzwerktransport und Telemetrie; dynamische Transportauflösung und direkter Testeingriff in Endpoint-Globals entfernt, zwei unvollständige Fehlerfalltests ergänzt. F6j: Upload-Freigaben mit explizitem Datenbankzugang und einmaliger Adapterauflösung; synchrone DB-/Signierungsarbeit im Threadpool, Provider- und echte DB-Verträge ergänzt. F6k: Upload-Freigaben mit explizitem Speicher und vollständig ohne dynamische Learning-Fassade; getrennte Dialog-Provider ohne globalen Testschalter. Abgabevalidierung frameworkunabhängig; Worker-Kontext-/Ergebnispersistenz und H5P-Router getrennt. Nachweise im Backend-Schuldenpakete-Plan vom 2026-09-08. Übrige BFF-/Teaching-/Learning-Provider und Reparatur-Fixtures bleiben offen |
...
| TD-009 | Lehrkraft-Katalog | Mit Kurs-/Einheitenzahl wachsende DB-Abfragekosten | Bestehende Einzelabfragen je Kurszuordnung und je Abschnittsliste; bisherige Listenbegrenzungen | Produktverantwortlicher | 2026-10-01 | Gebündelte eigentümergebundene Katalogabfrage mit echten DB-Paritäts-, Grenzfall- und Abfragezahltests | erledigt | Gebündelte Leseoperationen implementiert: 24 gezielte Katalog-/Home-/Isolationstests einschließlich DB-Parität bei 0, 1, 20 und 201 Einträgen erfolgreich; make verify erfolgreich mit 3035 Backend-, 688 Frontend-, 8 Tooling- und 67 H5P-Tests; Detailnachweis im Backend-Schuldenpakete-Plan vom 2026-09-08 |
| TD-010 | Dialog-Zugriffsvertrag | Unübersetzte DB-Fehler und unklare Grenzen nach Zugriffsänderung | Start einer nicht sichtbaren Aufgabe wirft NoDataFound statt dokumentierter HTTP 404; eigene bestehende Dialoge sind nach Freigabe-/Mitgliedschaftsentzug weiterhin lesbar | Produktverantwortlicher | 2026-09-15 | Startfehler vertragsgerecht abbilden; Zugriff auf bestehende Dialoge ausdrücklich gegenüber Historie/Portfolio entscheiden und mit echten DB-/API-Verträgen absichern | offen | Im echten DB-Charakterisierungstest test_dialog_provider_preserves_database_ownership_and_private_context reproduziert; fremde Dialoge werden mit 404 geschützt. Kein stilles Ändern bestehender Rechte im Strukturrefactoring |
