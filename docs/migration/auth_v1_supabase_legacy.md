# GUSTAV Authentication (v1 – Supabase) and Migration Notes (Archived)

**Status**: Legacy reference for GUSTAV v1 (Supabase Auth / GoTrue). Not applicable to alpha‑2 (Keycloak).

For the current alpha‑2 identity/session design, see `docs/references/user_management.md`.

The remainder of this file is preserved for historical context and migration troubleshooting.
