...
- [CONSISTENCY] Prod-Redirect für app.gustav.example fehlt — Evidenz: `keycloak/realm-gustav.json` — Impact: Realm-Import in Prod führt zu „Invalid redirect URI“. — Fix: Ergänze `https://app.gustav.example/*` in `redirectUris`.
