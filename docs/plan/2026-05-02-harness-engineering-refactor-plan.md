...
- Offen für C4: `backend/web/routes/app.py` enthält weiterhin Live-Matrix, Live-Course-Units, Live-Dashboard und Detail-Sheet-Read-Models. Die nächsten Schnitte sollen Live-Read-Models in ein fokussiertes Modul verschieben. Jeder Schnitt braucht einen Contract-Test, der Modulbesitz, Router-Pfade oder Helper-Besitz schützt, plus die bestehenden Profil-, Session-, Header-, Route-Map- und API-Contract-Tests.
