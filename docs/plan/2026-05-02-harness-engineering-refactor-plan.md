...
- Acceptance:
  ...
  - Done in working tree: `docs/harness/IMPORT_BOUNDARY_BASELINE.json` now pins `flat_routes_imports` at 286 and `sys_path_mutations` at 49; `backend_web_routes_imports` is reduced to 0.
