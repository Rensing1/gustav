...
- Acceptance:
  ...
  - Done in working tree: `docs/harness/IMPORT_BOUNDARY_BASELINE.json` now pins `flat_routes_imports` at 324 and `sys_path_mutations` at 51; `backend_web_routes_imports` remains unchanged at 22.
