...
| F | Explizite typisierte Provider statt Route-Fassaden und Endpoint-Globals; isolierte Backend-Verdrahtung in Tests; Abgabe-/Workerphasen und H5P-Router entkoppelt | begonnen: Profil-/CLI-, Kummerkasten-, Lernenden-Kurs-, Lehrer-Katalog-, Inhaltseditor-, Graph-, Modulinhalt-, Materialabruf- und Abschnittsprovider migriert; Gesamtmigration offen |
