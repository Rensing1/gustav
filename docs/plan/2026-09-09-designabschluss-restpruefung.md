...
**Reparaturstand · 10. September 2026:** Alle Einträge DS-26–32 sind inzwischen im [siebenpaketigen Reparaturplan](2026-09-10-designkonsistenz-reparatur.md) lokal abgenommen; die Einzelbelege stehen unmittelbar unter den jeweiligen Befundüberschriften. Die folgenden Untersuchungsprotokolle bleiben als historische Nachweise erhalten.
...
**Reparaturstatus 10. September 2026: behoben.** Die zweite Präsentation trägt „Wiederholung“ und erklärt den Erhalt bisheriger Antworten. Nur das vorhandene Feld `presentation_number` wird ausgewertet; Zählung und Bewertungslogik bleiben unverändert. Vollständiges Gate `practice-session` mit Musterlösung, Wiederholung, echter H5P-Auswertung, Abschluss und unverändertem Nachlesen der ersten Antwort bestanden. 32 Bilder tatsächlich gesichtet, darunter [Wiederholung dunkel](assets/2026-09-10-designreparatur-paket7/repetition-390-dark.png), [erste Präsentation hell](assets/2026-09-10-designreparatur-paket7/first-presentation-320-light.png) und [Abschluss](assets/2026-09-10-designreparatur-paket7/completed-1440-light.png). Folgend der ursprüngliche Befund.
...
**Reparaturstatus 10. September 2026: behoben.** Abschnittsüberschriften haben einen einheitlichen inneren Abstand und bleiben beim folgenden Inhalt. Lange Materialien nutzen den verfügbaren Platz und fließen über Seiten; Markdown-Inhaltsüberschriften erhalten nicht irrtümlich die Modulgestaltung. Zwölf Renderertests und das vollständige Gate `teacher-unit-print` bestanden. Die echte sechsseitige Druckfassung mit Text, Bild und zweitseitigem Quellen-PDF wurde vollständig gerendert und gesichtet: [Textbeginn](assets/2026-09-10-designreparatur-paket7/p7-final-print-page-1.png), [Bild und Abschnittswechsel](assets/2026-09-10-designreparatur-paket7/p7-final-print-page-4.png), [Querformatquelle](assets/2026-09-10-designreparatur-paket7/p7-final-print-page-6.png), [vollständiges PDF](assets/2026-09-10-designreparatur-paket7/mixed-materials.pdf). Folgend die ursprüngliche Beobachtung.
...
**Behoben und lokal abgenommen am 10. September 2026:** DragQuestion startet auf einer echten scrollbaren Renderfläche mit mindestens 16 px gemessener Karten-/Beschriftungsschrift. „Gesamtansicht“ bleibt bewusst verkleinert; Vergrößern/Verkleinern verwenden reguläres H5P-Resize, keine optische Transformation. Fokus scrollt das aktive Element sichtbar. Beide vollständigen H5P-Gates und echte Maus-/Tastaturauswertung mit gespeichertem Ergebnis bestanden. Gesichtet: [390 px dunkel, lesbar](assets/2026-09-10-designreparatur-paket4/drag-readable-390-dark.png), [320 px hell](assets/2026-09-10-designreparatur-paket4/drag-readable-320-light.png) und [bewusste Übersicht](assets/2026-09-10-designreparatur-paket4/drag-overview-390-light.png). Die folgenden Absätze dokumentieren den Zustand vor der Reparatur.
