...
| Web | CLI_TOKENS_BACKEND | db | db | env/.env | Persistenz für opake CLI-Tokens |
...
| KC | KC_BASE_URL | http://keycloak:8080 | Interne IdP-Adresse | env/.env | Serverzugriff auf Keycloak im Dienstnetz |
...
| Frontend | COURSE_INVITE_INTENT_SECRET | Kein Default | Eigenständiges Secret, mindestens 32 Bytes | env/.env | Signierter Einladungswunsch, keine Anmeldesitzung |
