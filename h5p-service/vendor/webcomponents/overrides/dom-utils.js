import AwaitLock from './vendor/await-lock.js';

/**
 * This file is a small, browser-compatible override for
 * `@lumieducation/h5p-webcomponents/build/es2015/dom-utils.js`.
 *
 * Why:
 * - Upstream uses a bare import `await-lock`, which requires import maps/bundlers.
