<#-- 
  GUSTAV email verification template (German, minimalistic).

  Intent:
    - Confirm a new user's email address for the GUSTAV learning platform.
    - Keep wording friendly, neutral and role-agnostic (students and teachers).
-->
<!DOCTYPE html>
<html lang="de">
  <head>
    <meta charset="UTF-8" />
    <title>E-Mail-Adresse bestätigen – GUSTAV</title>
  </head>
  <body style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background-color: #f5f5f5; margin: 0; padding: 24px;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 24px; border-radius: 8px;">
      <tr>
        <td>
          <h1 style="font-size: 20px; margin: 0 0 16px 0;">Willkommen bei der GUSTAV-Lernplattform</h1>
          <p style="margin: 0 0 12px 0;">
            Hallo,
          </p>
          <p style="margin: 0 0 16px 0;">
            bitte bestätige deine E-Mail-Adresse, um dich bei GUSTAV anmelden zu können.
          </p>
          ...
          <p style="margin: 24px 0 8px 0; font-size: 13px; color: #555555;">
            Wenn du diese Registrierung nicht selbst ausgelöst hast, kannst du diese E-Mail ignorieren.
          </p>
          <p style="margin: 0 0 8px 0; font-size: 13px; color: #555555;">
            Bei Fragen melde dich unter: <a href="mailto:${properties.supportEmail!'support@gustav-lernplattform.de'}">${properties.supportEmail!'support@gustav-lernplattform.de'}</a>
          </p>
