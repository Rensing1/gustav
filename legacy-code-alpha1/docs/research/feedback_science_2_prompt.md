...
*   **Technischer Stack:** Die Plattform nutzt Streamlit für das Frontend und ein lokales Supabase-Backend. Die KI-Komponente wird durch **lokal gehostete, relativ kleine LLMs** (z.B. 8-Milliarden-Parameter-Modelle wie Llama 3 8B oder Gemma 3 8B) über Ollama betrieben. Die Orchestrierung und Optimierung der LLM-Aufrufe soll über das **DSPy-Framework** erfolgen.
