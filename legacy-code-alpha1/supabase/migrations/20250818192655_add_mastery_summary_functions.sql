-- Migration: Add optimized mastery summary functions
-- Description: Adds RPC functions for efficient mastery progress retrieval

-- Function to get mastery summary statistics
...
-- Function to count tomorrow's due tasks
...
COMMENT ON FUNCTION get_mastery_summary IS 'Returns aggregated mastery statistics for a student in a specific course';
COMMENT ON FUNCTION get_due_tomorrow_count IS 'Returns count of mastery tasks due tomorrow for a student in a specific course';
