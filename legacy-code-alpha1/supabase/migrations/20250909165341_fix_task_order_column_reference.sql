-- Fix task_order column reference to use correct order_in_section column
-- The task_base table uses order_in_section, not task_order
...
BEGIN
    ...
    SELECT 
        ...
        t.task_type,
        t.order_in_section as task_order,  -- Fixed column reference
        s.id as section_id,
    ...
    GROUP BY t.id, t.title, t.task_type, t.order_in_section, s.id, s.title, s.section_order
    ORDER BY s.section_order, t.order_in_section;  -- Fixed column reference
END;
$$;