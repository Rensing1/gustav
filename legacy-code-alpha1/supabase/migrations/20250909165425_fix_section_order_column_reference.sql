-- Fix section_order column reference to use correct order_in_unit column
-- The unit_section table uses order_in_unit, not section_order
...
BEGIN
    ...
    SELECT 
        ...
        s.order_in_unit as section_order,  -- Fixed column reference
        COALESCE(
            json_agg(
                json_build_object(
    ...
    ORDER BY s.order_in_unit, t.order_in_section;  -- Fixed column reference
END;
$$;