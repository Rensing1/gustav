-- Fix _get_submission_status_matrix_uncached to return student-oriented structure
-- as expected by the Python code

DROP FUNCTION IF EXISTS public._get_submission_status_matrix_uncached(TEXT, UUID, UUID, UUID);
...
GRANT EXECUTE ON FUNCTION public._get_submission_status_matrix_uncached TO authenticated;
GRANT EXECUTE ON FUNCTION public._get_submission_status_matrix_uncached TO service_role;

-- The wrapper function get_submission_status_matrix should continue to work as before