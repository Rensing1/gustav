-- Fix type casting for email column in _get_submission_status_matrix_uncached
...
BEGIN
    ...
    WITH enrolled_students AS (
        SELECT 
            ...
            COALESCE(NULLIF(p.full_name, ''), u.email)::TEXT as display_name  -- Explicit cast to TEXT
