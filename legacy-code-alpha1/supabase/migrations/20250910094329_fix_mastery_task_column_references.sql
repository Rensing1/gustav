-- Fix column references in get_next_due_mastery_task
-- The columns difficulty_level, concept_explanation, and prompt are in mastery_tasks table, not task_base
...
BEGIN
    ...
    WITH course_mastery_tasks AS (
        ...
        SELECT
            ...
            mt.difficulty_level,          -- From mastery_tasks table
            mt.concept_explanation,       -- From mastery_tasks table
            mt.prompt                     -- From mastery_tasks table
        FROM task_base t
