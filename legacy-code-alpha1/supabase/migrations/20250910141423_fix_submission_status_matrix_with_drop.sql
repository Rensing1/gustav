-- Fix get_submission_status_matrix function to use instruction instead of title
...
-- Recreate _get_submission_status_matrix_uncached to use instruction instead of title
