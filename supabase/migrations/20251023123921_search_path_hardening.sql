-- SECURITY DEFINER functions — search_path hardening
-- Ensure SECURITY DEFINER helpers do not depend on attacker-controlled schemas.

set check_function_bodies = off;

-- next_attempt_nr with hardened search_path
